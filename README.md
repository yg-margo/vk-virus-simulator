...
- Настроен scroll для UICollectionView, но я не успела исправить некоторую багу при покраске клеток и подсчете человек, когда скроллим. Пусть будет не баг, а фича, Христос Воскрес, значит и у инфицированных есть шанс! При пересчете таблицы, которая помещается в экран, персчёт и покраска работают верно. 
